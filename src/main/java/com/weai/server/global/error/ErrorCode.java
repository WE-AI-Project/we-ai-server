...
public enum ErrorCode {
	...
	ENVIRONMENT_VARIABLE_KEY_REQUIRED(HttpStatus.BAD_REQUEST, "ENVIRONMENT_VARIABLE_400_1", "Environment variable key is required."),
	ENVIRONMENT_VARIABLE_VALUE_REQUIRED(HttpStatus.BAD_REQUEST, "ENVIRONMENT_VARIABLE_400_2", "Environment variable value is required."),
	INVALID_ENVIRONMENT_VARIABLE_KEY(HttpStatus.BAD_REQUEST, "ENVIRONMENT_VARIABLE_400_3", "Environment variable key format is invalid."),
	ENVIRONMENT_VARIABLE_NOT_FOUND(HttpStatus.NOT_FOUND, "ENVIRONMENT_VARIABLE_404_1", "The requested environment variable could not be found."),
	ENVIRONMENT_VARIABLE_ALREADY_EXISTS(HttpStatus.CONFLICT, "ENVIRONMENT_VARIABLE_409_1", "An environment variable with the same profile and key already exists."),
	ENVIRONMENT_VARIABLE_ENCRYPT_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "ENVIRONMENT_VARIABLE_500_1", "Failed to encrypt the environment variable value."),
	ENVIRONMENT_VARIABLE_DECRYPT_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "ENVIRONMENT_VARIABLE_500_2", "Failed to decrypt the environment variable value."),
	ENVIRONMENT_VARIABLE_CREATE_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "ENVIRONMENT_VARIABLE_500_3", "Failed to create the environment variable."),
	ENVIRONMENT_VARIABLE_UPDATE_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "ENVIRONMENT_VARIABLE_500_4", "Failed to update the environment variable."),
	ENVIRONMENT_VARIABLE_DELETE_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "ENVIRONMENT_VARIABLE_500_5", "Failed to delete the environment variable."),
